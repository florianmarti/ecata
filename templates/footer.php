...
?>
     <footer> 
            <div class="footer-area home4-footer-bg home2 pt-100 pb-60">
                ...
                <div class="footer-top home4 pt-120 pb-70">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="row align-items-center justify-content-between">
                                <div class="col-xl-6  col-lg-5  col-md-12  col-sm-12 col-12">
                                    <div class="copyright-text text-center text-lg-left mt-20 mb-20">
                                        <p class="mb-0">Todos los derechos reservados 
                                            <a href="https://mostrodev.com" class="c-theme main-color f-500">Mostrodev</a>  ©  2024
                                        </p>
                                    </div>
                                </div><!-- /col -->
                                <div class="col-xl-6  col-lg-7  col-md-12  col-sm-12 col-12">
                                    <ul class="useful-link text-center text-lg-right mt-20">
                                        <li class="d-inline-block mb-20">
                                            <a href="about.html" class="secondary-color d-inline-block">Terminos &amp; Condiciones</a>
                                        </li>
